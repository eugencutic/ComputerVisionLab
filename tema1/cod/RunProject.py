...
from cod.BuildMosaic import build_mosaic


image_path = './../data/imaginiTest/dog.jpg'
params = Parameters(image_path)

# directorul cu imagini folosite pentru realizarea mozaicului
params.small_images_dir = 'cifar'
